...
<table class="table table-striped table-bordered" id="example2">
        ...
        <tbody>
            ...
            $no=1;
                ...
                if($_SESSION['data']['Role'] == 'admin' || $_SESSION['data']['Role'] == 'petugas'){ ?>
                    <td>
                        <a class="btn btn-danger btn-sm" href="dashboard.php?page=hapusUlasan&UlasanID=<?= $d['UlasanID'] ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')"><i class="fa fa-trash fa-sm text-white"></i></a>
                </td>
                <?php } ?>
                </tr>
             <?php   }
