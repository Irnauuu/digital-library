        ...
        <tbody>
            ...
            $no=1;
                ...
                <tr>
                  ...
                  <a class="btn btn-danger btn-sm" href="dashboard.php?page=hapusPeminjam&PeminjamanID=<?= $d['PeminjamanID'] ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')"><i class="fa fa-trash"></i></a>
              </td>
                </tr>
             <?php   }
            ?>
